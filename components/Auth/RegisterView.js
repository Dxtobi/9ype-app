    ...
    return (
      <View style={styles.containerStyle}>
        ...
        <View style={styles.inputContainerStyle}>
          ...
          <TouchableOpacity style={styles.redirectContainer} onPress={()=>{this.props.navigation.navigate('Login')}}><Text style={styles.redirect}>Already have an account</Text></TouchableOpacity>
